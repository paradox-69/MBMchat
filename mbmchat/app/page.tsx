...
export default function MBMChatWorkspace() {
  ...
  // Real-Time Live Camera Stream State for Snaps
  ...
  // Real-Time Live Camera Stream Controls for Snaps
  const startCamera = async (mode: 'user' | 'environment' = cameraFacingMode) => {
    ...
    try {
      ...
      alert('Camera access error or permission denied. Please allow camera access in browser settings.');
    }
  };
      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-12 py-4 px-2 sm:px-4">
          ...
          <main className="col-span-1 md:col-span-6 p-2 sm:p-6 overflow-y-auto mb-20 md:mb-0">
            ...
            {/* TAB: WALL (REAL-TIME LIVE CAMERA STREAM) */}
            {activeTab === 'wall' && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
